...
local function chat_list(msg)
    ...
    local message = '<b>List of Groups:\n*Use #join (ID) to join*\n\n</b>'
...
if to == 'user' or service or is_admin1(msg) and to == "chat" or to == "channel" then
	if is_gbanned(msg.from.id) then
        return '<b>You are globally banned.</b>'
	end
	...
	if msg.service and user_type == "support" and msg.action.type == "chat_add_user" and msg.from.id == 0 then
		...
		if username then
			send_large_msg("<b>user#id</b>"..user_id, "<b>Added support member\n</b>@"..username.."["..user_id.."]<b> to chat:\n </b>👥 "..group_name.." <b>(ID:</b>"..msg.to.id..")" )
		else
			send_large_msg("<b>user#id</b>"..user_id, "<b‌>Added support member</b>\n["..user_id.."] <b>to chat:\n </b>👥 "..group_name.." <b>(ID:</b>"..msg.to.id..")" )
		end
	end
	if msg.service and user_type == "admin" and msg.action.type == "chat_add_user" and msg.from.id == 0 then
		...
		if username then
			send_large_msg("<b>user#id"..user_id, "Added admin\n@"..username.."["..user_id.."] to chat:\n 👥 "..group_name.." (ID:</b>"..msg.to.id..")" )
		else
			send_large_msg("<b>user#id"..user_id, "Added admin:\n["..user_id.."] to chat:\n 👥 "..group_name.." (ID:</b>"..msg.to.id..")" )
		end
	end
	...
	if msg.service and user_type == "regular" and msg.action.type == "chat_add_user" and msg.from.id == 0 then
		...
		send_large_msg("<b>user#id"..user_id, "Added you to chat:\n\n"..group_name.." (ID:</b>"..msg.to.id..")")
	end
	...
	if matches[1] == 'help' and msg.to.type == 'user' or matches[1] == 'pmhelp' and is_admin1(msg) and msg.to.type ~= 'user' then
		...
		text = "Welcome: send me /superhelp😀"
     	return text
    end
